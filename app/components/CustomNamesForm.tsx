  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        {useCustomNames && (
          <div className={`space-y-3 p-3 rounded-lg border border-dashed transition-all duration-300 ${
            isDarkTheme ? 'border-gray-700 bg-gray-800/50' : 'border-gray-300 bg-gray-50'
          }`}>
            <div className="flex gap-2">
              <input
                ...
                className={`flex-1 border rounded px-3 py-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-0 text-sm ${
                  isDarkTheme 
              ...
              <button
                ...
                className={`px-3 py-2 rounded font-medium transition-all duration-300 text-sm ${
                  isDarkTheme 
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {selectedCustomNames.map((name) => (
                    <div
                      key={name}
                      className={`flex items-center gap-1 px-2 py-1 border rounded text-xs transition-all duration-300 ${
                        isDarkTheme 
              ...
              <div className="flex flex-wrap gap-1.5">
                {quickAddNames
                  ...
                  <button
                    ...
                    className={`px-2 py-1 border rounded text-xs transition-all duration-300 ${
                      isDarkTheme 
