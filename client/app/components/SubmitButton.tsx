  ...
  return (
    <div className="space-y-2">
      <button
        ...
        onClick={handleClick}
        className={`w-full font-semibold py-3 px-4 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-0 text-sm shadow-lg ${
          isButtonDisabled()
            ? isDarkTheme 
            ...
            : isDarkTheme 
              ? 'bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white focus:ring-orange-500 focus:ring-offset-black shadow-orange-500/25' 
              : 'bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white focus:ring-blue-600 focus:ring-offset-white shadow-blue-500/25'
        }`}
      >
