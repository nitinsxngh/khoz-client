  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-800/50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 backdrop-blur-sm"
      >
      ...
      {isDropdownOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute right-0 mt-2 w-64 bg-gray-900/90 border border-gray-700/50 rounded-xl shadow-2xl z-20 backdrop-blur-xl">
            <div className="p-4">
              {/* User Info */}
              ...
              {/* Menu Items */}
              <div className="py-2">
                <button className="w-full text-left px-3 py-2 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-lg transition-colors duration-200">
