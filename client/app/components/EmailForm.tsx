...
const EmailForm: React.FC<EmailFormProps> = ({
  ...
  return (
    <div className={`border rounded-xl p-6 transition-all duration-300 shadow-xl ${
      isDarkTheme 
        ? 'bg-gray-900/50 border-gray-800/50 backdrop-blur-xl' 
        ...
        <div className="space-y-3">
          ...
          {formData.domainFile && (
            <div className={`p-3 rounded-lg border transition-all duration-300 ${
              isDarkTheme 
                ? 'bg-blue-900/20 border-blue-700/50 text-blue-300 backdrop-blur-sm' 
                : 'bg-blue-50/80 border-blue-200/50 text-blue-700 backdrop-blur-sm'
            }`}>
              <div className="flex items-center space-x-2">
