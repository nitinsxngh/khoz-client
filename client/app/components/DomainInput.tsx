        ...
        <div className="flex gap-2">
          <div className="flex-1 relative">
            <input
              ...
              className={`w-full border rounded-lg px-4 py-2.5 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-0 text-sm backdrop-blur-sm ${
                isDarkTheme 
                  ? 'bg-gray-800/50 border-gray-700/50 text-white placeholder-gray-400 focus:ring-orange-500 focus:border-orange-500/50' 
                  : 'bg-gray-50/80 border-gray-300/50 text-gray-900 placeholder-gray-500 focus:ring-blue-600 focus:border-blue-600/50'
              } ${
          ...
          <div className="relative group">
            ...
            <label
              ...
              className={`flex items-center justify-center w-10 h-10 rounded-lg cursor-pointer transition-all duration-300 backdrop-blur-sm ${
                isDarkTheme 
                  ? 'bg-gray-800/50 border border-gray-700/50 hover:bg-gray-700/50 text-gray-400 hover:text-white' 
                  : 'bg-gray-100/80 border border-gray-300/50 hover:bg-gray-200/80 text-gray-500 hover:text-gray-700'
              }`}
            ...
            <div className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10 backdrop-blur-sm ${
              isDarkTheme 
              ...
              <div className={`absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-2 border-r-2 border-t-2 border-transparent ${
                isDarkTheme ? 'border-t-gray-900/90' : 'border-t-gray-800/90'
              }`}></div>
            </div>
          </div>
        </div>
